...
begin
  ...
  InserirLinhaEmBrancoNoChatBot;
  memoChat.Lines.Add('Vamos começar nossa jornada?');
end;

function TfrmTelaCadastroChatBot.ObterTextoInicialChatBot: string;
begin
  result := 'Olá! Prazer, eu sou Dreamy Bot. Estou aqui para te ajudar a realizar o seu cadastro, ' +
            ' que é o primeiro passo para a realização dos seus sonhos.';
end;
